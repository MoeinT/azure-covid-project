...
spark = SparkSession.builder.appName("experiments").getOrCreate()
...
if __name__ == "__main__":
    ...
    path_pop = os.path.join("..", "data", "population.tsv")
    path_lookup = os.path.join("..", "data", "country_lookup.csv")
    df_population_processed = population_processed(
        extract_population(path_pop), path_lookup
    )
    df_population_processed.show(5)
